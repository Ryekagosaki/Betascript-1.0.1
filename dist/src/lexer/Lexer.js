...
class Lexer {
    ...
    getKeyword(value) {
        const keywords = {
            ane: Token_1.TokenType.ANCE,
            ente: Token_1.TokenType.ENTE,
            ...
            ekspor: Token_1.TokenType.KASOH,
            ...
            tungguin: Token_1.TokenType.TUNGGU,
            tunggu: Token_1.TokenType.TUNGGU,
